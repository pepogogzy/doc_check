...
@section('header')
    <h2 class="font-semibold text-xl text-[#111110] dark:text-white leading-tight">Create Rule</h2>
@endsection
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-[#161615] border border-[#e5e5e0] dark:border-[#2a2a28] rounded-xl p-8 max-w-2xl">
                <h1 class="text-2xl font-semibold text-[#111110] dark:text-white mb-6">Create Rule</h1>
                <form action="{{ route('rules.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="6" required
                                  class="w-full border border-[#e5e5e0] dark:border-[#3a3a38] bg-white dark:bg-[#161615] text-[#111110] dark:text-white rounded-lg px-3 py-2 text-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('description') }}</textarea>
                    ...
                    <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm">Create Rule</button>
                </form>
            </div>
        </div>
    </div>
